                ...
                <div id="comment-<?php comment_ID(); ?>" class="comment">
                    ...
                    <div class="comment-inner">
                        ...
                        <div class="comment-header">
                            ...
                            <p class="comment-date"><a class="comment-date-link"
                                                       href="<?php echo esc_url(get_comment_link($comment->comment_ID)) ?>"
                                                       title="<?php echo get_comment_date() . ' at ' . get_comment_time(); ?>"><?php echo get_comment_date() . '<span> &mdash; ' . get_comment_time() . '</span>'; ?></a>
                            </p>
